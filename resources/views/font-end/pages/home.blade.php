...
@include('font-end.includes.hero-area')
    <!--==========================================
						...
						<div class="product-item bg-light">
                            <div class="card">
                                <div class="thumb-content">
                                    ...
                                    <a href="{{ route('/ads-details') }}">
                                        <img class="card-img-top img-fluid" src="{{ asset('/') }}font-end/images/products/products-2.jpg"  alt="Card image cap">
                                    </a>
                                </div>
                                <div class="card-body">
